      ...
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-6 md:flex-row md:items-center">
        ...
        <div className="flex flex-col md:items-end gap-2 text-sm text-ink-muted">
          <div className="flex gap-4 mb-1">
            <Link href="/privacy" className="text-xs hover:text-ink transition-colors underline underline-offset-2">Privacy</Link>
            <Link href="/terms" className="text-xs hover:text-ink transition-colors underline underline-offset-2">Terms</Link>
          </div>
